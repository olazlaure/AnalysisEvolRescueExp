...
# #merge dataset
# temp_Start <- data[data$Generation_Eggs==2,c("Block","Population",
#                          "Genetic_Diversity","Lambda", "He_remain", "He_end" )]
# temp_Start$ID_Rep <- 1
# temp_Start$Phenotyping <- "Initial"
# 
# temp_end <- data_phenotyping[,c("Block","Population",
#                                 "Genetic_Diversity","Lambda","ID_Rep", "He_remain", "He_end" )]
...
# 
# PLOT_He_Initial <- ggplot2::ggplot(data[data$Generation_Eggs==2,], aes(x = He_remain, y = Lambda, 
#                          colour = Genetic_Diversity)) + 
