...
## Change name vector 
vector_names <- c(`Low` = "Double-bottleneck",
                    `Medium` = "Single-bottleneck",
                    `High` = "Diverse-source")
...
PLOT_Pop_size_predict<-ggplot2::ggplot(data[data$Extinction_finalstatus=="no",], 
  ...
  scale_color_manual(name="Genetic history",
                    ...
                    labels = c("Diverse-source","Single-bottleneck","Double-bottleneck"), 
...
PLOT_He_extinction <-ggplot2::ggplot(data, aes(x = factor(Generation_Eggs), 
  ...
  ylab("Expected remaining heterozygozity") +
  scale_color_manual(values = c("black", "red")) +
