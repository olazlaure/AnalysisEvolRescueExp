...
ggplot(data = mod_block_P, aes(Generation_Eggs, fit)) +
    facet_wrap(~ Block) +
  geom_smooth_ci(Genetic_Diversity)
...
# 
#   geom_point(data, aes(x = factor(Generation_Eggs),
#                                 y = Nb_adults,
#                                 group = Population,
#                                 colour = Genetic_Diversity),
#              position = position_dodge(0.4), size = 0.8, alpha = 0.7) +
#   geom_line(data, aes(x = factor(Generation_Eggs),
#                                 y = Nb_adults,
#                                 group = Population,
#                                 colour = Genetic_Diversity),
#             position = position_dodge(0.4), size = 0.2, alpha = 0.6) +
# 
 ...
 # xlim (1,6) + 
  geom_point(data = data[data$Extinction_finalstatus=="no",], 
             aes(x = Generation_Eggs,
                                ...
                                group = Population,
                                colour = Genetic_Diversity),
             position = position_dodge(0.15), size = 0.5, alpha = 0.8) + 
    scale_color_manual(name="Genetic history",
                     breaks = c("High", "Medium", "Low"), 
                    labels = c("Diverse","Intermediate bottleneck","Strong bottleneck"), 
